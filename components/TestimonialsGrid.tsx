...
export default function TestimonialsGrid({
  ...
  subheadline = 'Real reviews from diners who return for the flavors, service, and atmosphere.',
  testimonials = [
    {
      quote: 'The short rib was perfectly tender and the saffron risotto was unforgettable. A top-tier dining experience.',
      name: 'Amelia Brooks',
      title: 'Local Food Critic',
      rating: 5,
    },
    {
      quote: 'Warm hospitality, beautiful plating, and incredible desserts. We celebrated our anniversary here and loved it.',
      name: 'Daniel Reyes',
