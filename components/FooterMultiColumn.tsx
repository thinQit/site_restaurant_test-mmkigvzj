...
export default function FooterMultiColumn({
  brand = 'Saffron Hearth',
  description = 'Refined dining inspired by regional harvests, slow cooking, and warm hospitality.',
  columns = [
    {
      title: 'Menu',
      links: [
    ...
    },
    {
      title: 'Contact',
      links: [
        { label: '(555) 123-9876', href: 'tel:+15551239876' },
        { label: 'hello@saffronhearth.com', href: 'mailto:hello@saffronhearth.com' },
        { label: '125 Olive Lane, Downtown', href: '#contact' },
      ],
    },
    {
      title: 'Social',
